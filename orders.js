...
class Tickets {	
    ...
    this.status = 'The order for customr', this.name, 'is now' this.newStatus'	
                  
    }
}       console.log(`The order for customr', ${this.name}, 'is now ${newStatus}`)	
...
let firstTicket = new Ticket('pizza', 'bread', 'soda', '19:03', 575 )
